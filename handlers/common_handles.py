...
async def services_handler(callback: CallbackQuery):
    ...
    await callback.message.answer(services_text, parse_mode="Markdown")
...
async def contacts_handler(callback: CallbackQuery):
    ...
    await callback.message.answer(contacts_text, parse_mode="Markdown")
...
async def back_to_start_handler(callback: CallbackQuery):
    ...
    from handlers.client_handlers import start_handler
